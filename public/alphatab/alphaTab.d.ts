...
declare class AlphaSynthBase implements IAlphaSynth {
  ...
  constructor(
    output: ISynthOutput,
    synthesizer: IAudioSampleSynthesizer,
...
declare interface CoreSettingsJson {
   ...
   * @since 1.6.0
   */
  smuflFontSources?: Map<
    FontFileFormat | keyof typeof FontFileFormat | Lowercase<keyof typeof FontFileFormat>,
    string
  >
  /**
   * The full URL to the input file to be loaded.
...
export declare namespace importer {
  export { ScoreImporter, ScoreLoader, UnsupportedFormatError, AlphaTexImporter }
}
...
export declare namespace io {
  export { IWriteable, IReadable, ByteBuffer, IOHelper }
}
...
declare interface NotationSettingsJson {
   ...
   */
  elements?: Map<
    NotationElement | keyof typeof NotationElement | Lowercase<keyof typeof NotationElement>,
    boolean
  >
  /**
   * Controls how the rhythm notation is rendered for tab staves.

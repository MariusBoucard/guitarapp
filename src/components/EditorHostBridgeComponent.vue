    ...
    <div class="bridge-section">
      ...
      <div class="config-group">
        ...
        <div class="path-input-group">
          ...
          />
          <button @click="browseEditorHost" :disabled="editorHostRunning" class="browse-button">
            📂 Browse
          </button>
        </div>
        <button
    ...
    <div class="bridge-section" v-if="editorHostRunning">
      ...
      <div class="plugin-controls">
        <div class="plugin-input-group">
          <input v-model="selectedPluginPath" type="text" placeholder="VST3 Plugin Path" readonly />
          <button @click="browsePlugin" class="browse-button">📂 Browse Plugin</button>
        </div>
        <button
      ...
      <div class="embed-controls">
        <div class="embed-container" ref="embedContainer">
          <div v-if="!windowEmbedded" class="embed-placeholder">
            ...
            <button @click="embedWindow" class="action-button embed">🔗 Embed Window</button>
          </div>
          <div v-else class="embedded-info">
            <p>✅ EditorHost window is embedded</p>
            <button @click="detachWindow" class="action-button detach">🔓 Detach Window</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bridge-section" v-if="editorHostRunning">
      ...
      <div class="window-info">
        ...
        <div v-if="windowInfo.windowRect" class="info-item">
          <strong>Window Size:</strong> {{ windowInfo.windowRect.width }}x{{

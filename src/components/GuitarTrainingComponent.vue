    ...
    <div class="main-content">
      <div class="row" :class="{ 'sidebar-folded': isRightColumnFolded }">
        <div class="column">
          <div>
            ...
            <VideoComponentNewRefactored
              v-show="appStore.videoDisplayNew"
              ref="videoPlayer"
            ></VideoComponentNewRefactored>
            <TabReaderComponent v-show="appStore.tabReaderDisplay"></TabReaderComponent>
            <UserManagementComponent
              v-show="appStore.userManagementDisplay"
              @close="appStore.toggleUserManagement()"
            ></UserManagementComponent>
        ...
        <div class="columnd" v-show="!isRightColumnFolded">
          ...
          <SuggestedChordsComponent v-show="appStore.chordssuggestDisplay" />
          <NoteToPlayComponent
          ...
          ></ColorComponent>
          <GammeFinderComponent v-show="appStore.scalesDisplay"></GammeFinderComponent>
        </div>
      </div>
    </div>
  </div>
        ...
        reader.onload = (e) => {
          try {
            ...
            if (importedData.metadata && importedData.states) {
              ...
              if (
                importedData.currentTrainingData &&
                importedData.currentTrainingData.trainingList
              ) {
                ...
                if (shouldImportTrainings) {
                  ...
                  trainingStore.selectedTraining =
                    importedData.currentTrainingData.selectedTraining || 0
                  trainingStore.currentTrainingName =
                    importedData.currentTrainingData.currentTrainingName || ''
                  trainingStore.saveTrainingsToStorage()

...
export class ComponentManager {
        ...
        components: [
          {
            ...
            name: 'Manche',
            icon: '🎸',
            action: () => this.appStore.toggleManche(),
          },
          {
            key: 'notesSelectedDisplay',
            name: 'Selection notes',
            icon: '🎵',
            action: () => this.appStore.toggleNotesSelected(),
          },
          {
            key: 'keyboard',
            name: 'Keyboard',
            icon: '⌨️',
            action: () => this.appStore.toggleKeyboard(),
          },
        ],
      },
      tools: {
        ...
        components: [
          {
            ...
            name: 'Tuner',
            icon: '🎛️',
            action: () => this.appStore.toggleTuner(),
          },
          {
            key: 'scalesDisplay',
            name: 'Scales',
            icon: '🎼',
            action: () => this.appStore.toggleScales(),
          },
          {
            key: 'chordssuggestDisplay',
            name: 'Chord Suggestions',
            icon: '🎹',
            action: () => this.appStore.toggleChordssuggestion(),
          },
        ],
      },
      media: {
        ...
        components: [
          {
            ...
            name: 'Play Sound',
            icon: '🔊',
            action: () => this.appStore.toggleSound(),
          },
          {
            key: 'videoDisplay',
            name: 'Play Video',
            icon: '📹',
            action: () => this.appStore.toggleVideo(),
          },
          {
            key: 'videoDisplayNew',
            name: 'Play Video New',
            icon: '🎬',
            action: () => this.appStore.toggleVideoNew(),
          },
          {
            key: 'pictureDisplay',
            name: 'Display Picture',
            icon: '🖼️',
            action: () => this.appStore.togglePicture(),
          },
        ],
      },
      training: {
        ...
        components: [
          {
            ...
            name: 'Play Game',
            icon: '🎮',
            action: () => this.appStore.toggleGame(),
          },
          {
            key: 'autoGammeSelect',
            name: 'Auto Gamme Select',
            icon: '🔄',
            action: () => this.appStore.toggleAutoGammeSelect(),
          },
        ],
      },
      settings: {
        ...
        components: [
          {
            ...
            name: 'Settings',
            icon: '⚙️',
            action: () => this.appStore.toggleSettings(),
          },
        ],
      },
    }
  ...
  getActiveComponents() {
    return this.getAllComponents().filter((component) => this.appStore[component.key])
  }
